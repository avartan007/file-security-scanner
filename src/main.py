...
class SecurityPipeline:
    """Main workflow controller - orchestrates scanning, organizing, and reporting."""
    ...
    def __init__(self):
        ...
        os.makedirs(os.path.join(self.files_dir, "approved"), exist_ok=True)
        os.makedirs(os.path.join(self.files_dir, "suspicious"), exist_ok=True)
    ...
    def option_scan(self):
        ...
        print("\n[*] Scanning files in ./books/ (including subdirectories)\n")
    ...
    def option_organize(self):
        ...
        for result in results:
            ...
            ti.record_file(file_hash, filename, "Local_Scan", risk_level=risk)
    ...
    def option_results(self):
        ...
        suspicious = sum(1 for r in results if r.get("risk_level") != "CLEAN")
